...
//
//		glUniform3f(glGetUniformLocation(lightingShader.getProgramID(), "light.ambient"), 0.2f, 0.2f, 0.2f); // Note that all light colors are set at full intensity
//		glUniform3f(glGetUniformLocation(lightingShader.getProgramID(), "light.diffuse"), 0.5f, 0.5f, 0.5f);
//		glUniform3f(glGetUniformLocation(lightingShader.getProgramID(), "light.specular"), 1.0f, 1.0f, 1.0f);
